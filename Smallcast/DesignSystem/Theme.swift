...
enum Theme {
    ...
    enum Size {
        ...
        /// Smallcast's own dialog: fixed width, height measured from the SwiftUI content.
    ...
    /// Motion owned by Smallcast's menus; extension-provided panels keep their own behavior.
    @MainActor
    enum MenuMotion {
