...
struct AISettingsView: View {
        ...
        Section {
            if modelGroups.isEmpty {
                ...
                Picker(selection: modelBinding) {
                    ...
                    Text("Default model")
                    Text("Used by Smallcast features unless they ask you to choose another model.")
                }
            ...
            Text(
                modelGroups.isEmpty
                    ...
                    : "Smallcast contacts only the selected provider when an AI feature runs."
            )
            .font(.caption)
            .foregroundStyle(.secondary)
        }
    ...
    private var systemPromptSection: some View {
        ...
        return Section {
            Toggle(isOn: $settings.systemPromptEnabled) {
                ...
                Text("Off sends nothing ahead of your message, not even what Smallcast says about itself.")
            }
            ...
            Text(
                "Your text is sent ahead of every message in every chat, after what Smallcast already tells the model about itself — so both are billed again on each turn."
            )
            .font(.caption)
            .foregroundStyle(.secondary)
        }
    ...
    private var chatGPTSection: some View {
        Section {
            ...
            Text(
                "Uses OpenAI’s supported Codex App Server. The sign-in is stored in Smallcast’s "
    ...
    private var chatGPTConnection: some View {
        ...
        case .waitingForBrowser:
            LabeledContent {
                ...
                Text("Return to Smallcast after the browser confirms sign-in.")
            }
        case .connected:
