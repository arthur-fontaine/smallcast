...
struct AISettingsView: View {
    ...
    private var systemPromptSection: some View {
        ...
        return Section {
            ...
            Text(
                "Your text is sent ahead of every message in every chat, after what Smallcast "
    ...
    private var installedAISection: some View {
        Section {
            ...
            Text(
                "Smallcast uses the Codex, Claude and OpenCode commands already installed and signed "
                    + "in on this Mac. Smallcast never stores or asks for their API keys."
            )
            .font(.caption)
            .foregroundStyle(.secondary)
        }
        ...
        if settings.enabledInstalledProviders.contains(kind) {
            ...
            case .notInstalled:
                LabeledContent {
                    ...
                    Text("Smallcast could not find the \(kind.command) command.")
                }
            case .failed(let message):
                LabeledContent {
                    providerActions {
