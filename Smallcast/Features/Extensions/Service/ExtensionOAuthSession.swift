...
/// Opens authorization URLs in the default browser and captures `raycast://oauth`, `com.raycast:/oauth`, and `smallcast://oauth`
...
final class ExtensionOAuthSession {
    ...
    /// Handle deep links coming from NSApplicationDelegate (e.g. raycast://oauth?code=… or smallcast://oauth?code=…)
    static func handleCallbackURL(_ url: URL) -> Callback {
        guard let scheme = url.scheme?.lowercased(),
            scheme == "raycast" || scheme == "smallcast" || scheme == "com.raycast"
        else { return .ignored }
