...
struct ExtensionRegistriesSheet: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            VStack(alignment: .leading, spacing: Theme.Spacing.xs) {
                ...
                Text("Where Smallcast looks when you search for an extension to install.")
                    .font(.caption)
    ...
    /// Extra PATH folders Smallcast checks before its built-in list — for a package manager or Node
