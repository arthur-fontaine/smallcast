...
enum UpdateFailure: LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .noAppInArchive:
            return "The downloaded archive does not contain Smallcast."
        case .quarantined:
            return "macOS quarantined the downloaded app and Smallcast could not clear the flag."
        case .bundleMismatch:
            return "The downloaded app is not this build of Smallcast."
        case .identityMismatch:
        ...
        case .replaceFailed(let detail):
            return "Smallcast could not be replaced. \(detail)"
        }
    }
