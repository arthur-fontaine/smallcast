...
///
/// An archive Smallcast fetched itself is not quarantined — macOS sets the flag for sandboxed
/// downloaders and for apps that opt in with `LSFileQuarantineEnabled`, and Smallcast is neither —
