...
enum SettingsSearchCatalog {
    ...
    static let entries: [SettingsSearchEntry] =
        general + applications + search + systemSettings
        ...
        + extensions + permissions + backup + miscellaneous + about
    ...
    private static let calendar: [SettingsSearchEntry] = [
        ...
        .init(
            .calendarCalendar, "Join meetings from Smallcast",
    ...
    private static let backup: [SettingsSearchEntry] = [
        ...
        .init(
            ...
            keywords: ["save", "smallcast file", "archive"]),
        .init(
            .backupImport, "Backup File",
            keywords: ["restore", "choose", "smallcast file"]),
        .init(
