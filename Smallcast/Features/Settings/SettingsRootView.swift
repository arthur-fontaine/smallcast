...
extension Notification.Name {
    ...
    static let smallcastSelectSettingsTab = Notification.Name("SmallcastSelectSettingsTab")
...
enum SettingsTab: Int, CaseIterable, Identifiable {
    case general, search, clipboard, emoji, extensions, permissions, shortcuts, backup, about
    var id: Int { rawValue }
...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .frame(maxWidth: .infinity, maxHeight: .infinity)
        .onReceive(NotificationCenter.default.publisher(for: .smallcastSelectSettingsTab)) { note in
