        ...
        Form {
            Section {
                LabeledContent {
                    ...
                    Text("Accessibility")
                    Text("Lets Smallcast paste a clipboard item into the app you were using.")
                }
                ...
                Text("Access Smallcast needs to work with other apps.")
                    .font(.caption)
            ...
            Section {
                LabeledContent {
                    ...
                    Text("Calendars")
                    Text("Lets Smallcast find the join link for the meeting you are about to be in.")
                }
