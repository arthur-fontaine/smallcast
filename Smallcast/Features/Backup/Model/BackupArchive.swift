...
/// Seals a `BackupBundle` directory into one `.smallcast` file, and opens one back up.
enum BackupArchive {
    static let fileExtension = "smallcast"
    ...
    enum ArchiveError: LocalizedError, Equatable {
        ...
        var errorDescription: String? {
            ...
            case .cannotRead: return "This file isn't a Smallcast backup, or it's damaged."
            }
        }
    }
