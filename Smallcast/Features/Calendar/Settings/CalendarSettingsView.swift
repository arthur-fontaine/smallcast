    ...
    var body: some View {
        ...
        Form {
            FeatureSwitchSection(
                ...
                enableTitle: "Join meetings from Smallcast",
                enableSubtitle:
            ...
            if settings.calendarEnabled, store.access == .notDetermined {
                Section {
                    SettingsRow(
                        ...
                        subtitle: "Allow Smallcast to read events and find meeting links."
                    ) {
                ...
                Section {
                    SettingsRow(
                        ...
                        subtitle: "Turn Smallcast on under Privacy & Security ▸ Calendars."
                    ) {
