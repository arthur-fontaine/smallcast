...
/// What Smallcast remembers per moved window. docs/features/window-management.md#cycling-and-restore
struct WindowActionMemory<Key: Hashable> {
    struct Record: Equatable, Sendable {
        /// Where the window was before Smallcast first touched it.
