...
enum CustomQuickActionError: Error, LocalizedError, Equatable {
    ...
    var errorDescription: String? {
        ...
        case .invalidCharacter: return "The name contains a character Smallcast can't store."
        case .storageUnavailable: return "Smallcast couldn't save to its actions file."
        }
    }
}
