...
struct CustomQuickActionEditorSheet: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: Theme.Spacing.xl) {
            ...
            Text("Smallcast sends your selected text to the model with these instructions.")
    ...
    private var instructionsField: some View {
        VStack(alignment: .leading, spacing: Theme.Spacing.sm) {
            ...
            Text(
                "Smallcast always tells the model to return only the transformed text, and to treat "
