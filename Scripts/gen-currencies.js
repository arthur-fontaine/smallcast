#!/usr/bin/env node
// Generate Smallcast/Features/Calculator/Model/CurrencyData.generated.swift.
//
...
async function main() {
  ...
  const out = path.resolve(__dirname, "..", "Smallcast/Features/Calculator/Model/CurrencyData.generated.swift");
