...
const ANCHORS = "Smallcast/Features/Settings/SettingsAnchor.swift";
const CATALOG = "Smallcast/Features/Settings/SettingsSearchCatalog.swift";
...
const source = swiftSources(path.join(ROOT, "Smallcast"))
