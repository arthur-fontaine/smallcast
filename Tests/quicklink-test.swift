...
struct QuicklinkTests {
    ...
    static let home = "/Users/smallcast-harness"
    ...
    static func pathDetection() {
        ...
        expect(
            detect("  ~/Projects/Smallcast  ") == .path("\(home)/Projects/Smallcast"),
    ...
    static func scratchDirectory() -> URL {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("smallcast-quicklink-test-\(UUID().uuidString)", isDirectory: true)
