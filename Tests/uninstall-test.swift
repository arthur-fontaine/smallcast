...
struct UninstallTests {
    ...
    static let ownBundleID = "com.smallcast.app"
    static let ownBundleURL = URL(fileURLWithPath: "/Applications/Smallcast.app")
    ...
    static func testIdentityRefusal() {
        let byID = UninstallTarget(
            ...
            bundleID: "com.smallcast.app", displayName: "Smallcast", bundleName: nil)
        expect(
            UninstallIdentity.make(
                target: byID, otherAppNames: [], ownBundleID: ownBundleID,
                ownBundleURL: ownBundleURL) == nil,
            "Smallcast refuses to plan its own uninstall by bundle ID")

        let dev = UninstallTarget(
            bundleURL: URL(fileURLWithPath: "/Applications/Smallcast Dev.app"),
            bundleID: "com.smallcast.app.dev", displayName: "Smallcast Dev", bundleName: nil)
        expect(
            UninstallIdentity.make(
                target: dev, otherAppNames: [], ownBundleID: "com.smallcast.app.dev",
                ownBundleURL: URL(fileURLWithPath: "/Applications/Smallcast Dev.app")) == nil,
