...
struct ExtensionTests {
    ...
    static func oauthUnitChecks() {
        ...
        let strayURL = URL(string: "smallcast://oauth?code=abc&state=xyz")!
        check(
    ...
    static func deepLinkChecks() {
        ...
        let tiny = ExtensionDeepLink.parse(
            url: URL(string: "smallcast://extensions/linear/linear/create-issue")!)
        check("deeplink mirrors raycast:// as smallcast://", tiny == canonical)
    ...
    static func runtimeChecks() async {
        ...
        let command = """
            ...
            module.exports.default = function Command() {
              ...
              const filePaths = [
                fileURLToPath("file:///Applications/Smallcast%20Beta.app"),
              ...
              const encrypted = Buffer.concat([encrypter.update("hello smallcast"), encrypter.final()]);
        ...
        check(
            ...
            ExtensionAccessoriesView_labelForTest(
                ...
                == "/Applications/Smallcast Beta.app\n/tmp/a#b.png\n"
        ...
        check(
            ...
            ExtensionAccessoriesView_labelForTest(
                ...
                + "ed019a3a90fa5f538f93782c6dbb8708,"
                + "hello smallcast,17d614f379a9359077e95577fd31c20a,ERR_OSSL_BAD_DECRYPT,"
    ...
    static func nodeContractChecks() async {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("smallcast-archive-\(UUID().uuidString)")
    ...
    static func swiftHelperChecks() async {
        let helper = FileManager.default.temporaryDirectory
            .appendingPathComponent("smallcast-helper-\(UUID().uuidString)")
    ...
    static func processKillChecks() async {
        let marker = FileManager.default.temporaryDirectory
            .appendingPathComponent("smallcast-rang-\(UUID().uuidString)")
        ...
        check(
            "exec returns a live pid and process.kill guards Smallcast itself",
