# Contributing to Smallcast

Check existing [issues](https://github.com/arthur-fontaine/smallcast/issues) and
[pull requests](https://github.com/arthur-fontaine/smallcast/pulls) first.
...
- **No bloat.** Smallcast stays small on purpose — quality over quantity. A clean patch still gets
...
- `open Smallcast.xcodeproj` → ⌘R. Debug builds are their own channel (`Smallcast Dev.app`).
...
macOS version, Smallcast version + channel, steps, expected vs actual. A recording beats a paragraph.
