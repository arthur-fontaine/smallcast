...
Include your macOS version, the Smallcast version and channel, reproduction steps, and the impact.
...
Current stable and beta only. Update (`brew upgrade --cask smallcast`) before reporting.
...
- **Network** — Smallcast is offline by default and every networked feature is consent-gated. A path
