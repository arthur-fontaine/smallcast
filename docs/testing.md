...
seconds to about 15. `SMALLCAST_TEST_JOBS=1` forces it back to one at a time. Parallelism is safe
...
| `launch-history-test` | `Launcher/Model/LaunchHistoryStore.swift` |
