...
and to prune bindings whose record was deleted while Smallcast wasn't running. That prune is why
...
window — that is un-remapped HID behaviour, not something Smallcast can stop.
