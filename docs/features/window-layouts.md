...
activation policy, since opening About flips Smallcast itself to `.regular`.
...
front**. Capturing from Settings marks nothing, because Smallcast itself is frontmost then.
