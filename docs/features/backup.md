...
Export and import of Smallcast's own settings, plus the entry point for importing a Raycast export. The
...
| `Model/RaycastImportV1.swift` | v1 → Smallcast field mapping and validation |
| `Model/RaycastImport.swift` | The shared `Result` and dispatcher |
| `Service/RaycastV2Decoder.swift` | v2 container decrypt and decode |
| `Service/RaycastImportV2.swift` | v2 → Smallcast field mapping |
